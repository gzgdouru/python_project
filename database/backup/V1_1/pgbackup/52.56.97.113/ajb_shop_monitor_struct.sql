...
CREATE FUNCTION cfl_test_insert_users(num integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
	declare i integer;
	declare p integer;
	begin
		...
		INSERT INTO tb_user_info(
			user_id, user_name, user_password, user_email, user_phone, user_mobile, 
			user_online, user_register_time, user_login_time, user_broker_ip, 
			user_broker_queue_name, user_broker_port, user_is_push, user_clientid, 
			user_type, user_ostype, user_device_id, user_app_type, user_parent_id, 
			user_sms_check_code, user_sms_check_time, user_image_address, 
			user_account, user_app_factory, user_soundfilename, user_address
		)
		VALUES (
			uuid_generate_v4(), 'test_user', 'e10adc3949ba59abbe56e057f20f883e', 'test_user@163.com', p, p,
			FALSE, now(),now(),'172.16.34.8','31760629-c90c-42eb-99f7-0262663c2eff4',
			5672,TRUE,'4f1fbdb4-c147-4975-83ea-b8444a107c95',1,1,'863654026415901',2,'a67f0000-e81b-00cc-a67f-0000e81b00cc','',now(),'','','anjubao','',''
		);
...
CREATE TABLE tb_device_scence_info (
    ...
    CONSTRAINT tb_device_scence_info_device_scence_status_check CHECK (((device_scence_status >= 0) AND (device_scence_status <= 100)))
);
...
--
-- Name: tb_sensor_linkage_action_info; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE tb_sensor_linkage_action_info (
    act_id uuid NOT NULL,
    act_link_event_id uuid,
    act_answer_sensor_id uuid,
    act_action integer,
...
ALTER TABLE tb_sensor_linkage_action_info OWNER TO admin;

--
-- Name: TABLE tb_sensor_linkage_action_info; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON TABLE tb_sensor_linkage_action_info IS '传感器联动动作表';


--
-- Name: COLUMN tb_sensor_linkage_action_info.act_link_event_id; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_action_info.act_link_event_id IS '联动事件id';


--
-- Name: COLUMN tb_sensor_linkage_action_info.act_answer_sensor_id; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_action_info.act_answer_sensor_id IS '响应联动事件的传感器id';


--
-- Name: COLUMN tb_sensor_linkage_action_info.act_action; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_action_info.act_action IS '联动动作. 0：关闭 1：打开';


--
-- Name: COLUMN tb_sensor_linkage_action_info.act_grade; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_action_info.act_grade IS '档次';


--
-- Name: COLUMN tb_sensor_linkage_action_info.act_answer_sensor_type; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_action_info.act_answer_sensor_type IS '响应联动事件的传感器类型';


--
-- Name: COLUMN tb_sensor_linkage_action_info.act_answer_sensor_name; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_action_info.act_answer_sensor_name IS '响应联动事件的传感器名称';


--
-- Name: COLUMN tb_sensor_linkage_action_info.act_answer_sensor_mac; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_action_info.act_answer_sensor_mac IS '响应联动事件的传感器mac';


--
-- Name: tb_sensor_linkage_condition_info; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE tb_sensor_linkage_condition_info (
    link_id uuid NOT NULL,
    link_trigger_sensor_id uuid,
    link_trigger_min_value integer,
    link_trigger_max_value integer,
    link_ipc_id uuid,
    link_trigger_value_type integer,
    link_event_id uuid,
    link_trigger_sensor_type integer,
    link_trigger_sensor_name text,
    link_trigger_sensor_mac text,
...
ALTER TABLE tb_sensor_linkage_condition_info OWNER TO admin;

--
-- Name: TABLE tb_sensor_linkage_condition_info; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON TABLE tb_sensor_linkage_condition_info IS '传感器联动条件信息';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_trigger_sensor_id; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_trigger_sensor_id IS '触发联动事件的传感器id';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_trigger_min_value; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_trigger_min_value IS '触发联动事件的最小阀值';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_trigger_max_value; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_trigger_max_value IS '触发联动事件的最大阀值';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_ipc_id; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_ipc_id IS 'ipc id';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_trigger_value_type; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_trigger_value_type IS '联动触发值类型';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_event_id; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_event_id IS '联动事件id
id相同表示同一个联动事件';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_trigger_sensor_type; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_trigger_sensor_type IS '触发联动事件的传感器类型';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_trigger_sensor_name; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_trigger_sensor_name IS '触发联动事件的传感器名称';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_trigger_sensor_mac; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_trigger_sensor_mac IS '触发联动事件的传感器mac';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_enable; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_enable IS 'true: 打开联动 false: 关闭联动';


--
-- Name: COLUMN tb_sensor_linkage_condition_info.link_cond_union; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN tb_sensor_linkage_condition_info.link_cond_union IS '1:满足所有触发条件才联动 
2:只要满足一个触发条件就会联动';
...
--
-- Name: tb_sensor_linkage_action_info tb_sensor_linkage_action_info_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY tb_sensor_linkage_action_info
    ADD CONSTRAINT tb_sensor_linkage_action_info_pkey PRIMARY KEY (act_id);


--
-- Name: tb_sensor_linkage_condition_info tb_sensor_linkage_condition_info_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY tb_sensor_linkage_condition_info
    ADD CONSTRAINT tb_sensor_linkage_condition_info_pkey PRIMARY KEY (link_id);
